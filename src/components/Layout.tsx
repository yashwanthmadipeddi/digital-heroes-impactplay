...
export default function Layout() {
  ...
  return <div className="app-shell"><ScrollProgress />
    ...
    <main><Outlet /></main>
    <footer className="footer"><div className="container footer-grid"><div><div className="brand footer-brand"><span className="brand-mark"><CircleDot size={15}/></span><span>impact<span>play</span></span></div><p>Cricket with purpose. Built to connect performance, community giving, and transparent monthly rewards.</p></div><div><div className="footer-label">Explore</div><Link to="/draws">Reward mechanics</Link><Link to="/charities">Cause directory</Link></div><div><div className="footer-label">Built with</div><span>React · Supabase · Stripe · Vercel</span><span className="footer-muted">© 2026 ImpactPlay demo</span></div></div></footer>
  </div>;
}
